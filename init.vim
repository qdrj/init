...
nnoremap xxterm :vert spl<Enter>:term<Enter><C-w>L
inoremap jmp ![]()<Esc>P
inoremap jmg ![]()<Esc>i
...
function OrderedList(n)
	let i = 1
	while i <= a:n
		exec "normal 0i" . i . ". jjj"
		let i = i + 1
	endwhile
endfunction

command -nargs=* OL :call OrderedList(<args>)
" monokai theme: 
"
" Vim color file
...
" ## Additional theme items for tab bar
hi TabLineFill ctermfg=Black ctermbg=Black
hi TabLine ctermfg=Gray ctermbg=Black
hi TabLineSel ctermfg=38 ctermbg=Black

" ## End Additional theme items for tab bar
...
hi User1 ctermfg=208 ctermbg=NONE guifg=#eea040 guibg=#222222
hi User2 ctermfg=Red ctermbg=NONE guifg=#dd3333 guibg=#222222
hi User3 ctermfg=81 ctermbg=NONE guifg=#ff66ff guibg=#222222
hi User4 ctermfg=148 ctermbg=NONE guifg=#a0ee40 guibg=#222222
hi User5 ctermfg=81 ctermbg=NONE guifg=#eeee40 guibg=#222222
